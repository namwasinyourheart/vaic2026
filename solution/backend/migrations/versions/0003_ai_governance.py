...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "document_id", sa.String(36), sa.ForeignKey("knowledge_documents.id"), nullable=False
        ),
        sa.Column("document_version_id", sa.String(36)),
        sa.Column("ai_clause_id", sa.String(255), nullable=False, unique=True),
        sa.Column("clause_path", sa.String(500)),
        sa.Column("effective_status", sa.String(40), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("right_document_id", sa.String(36)),
        sa.Column("ai_conflict_id", sa.String(255), nullable=False, unique=True),
        ...
        sa.Column("preferred_ai_clause_id", sa.String(255)),
        sa.Column("sync_status", sa.String(40), nullable=False),
    ...
    op.create_index(
        "ix_ai_ref_conflicts_left_document_id", "ai_ref_conflicts", ["left_document_id"]
    )
    op.create_table(
        "workflow_relation_reviews",
        sa.Column("id", sa.String(36), primary_key=True),
        sa.Column(
            "ai_relation_ref_id",
            sa.String(36),
            sa.ForeignKey("ai_ref_relations.id"),
            nullable=False,
        ),
        sa.Column("reviewer_id", sa.String(36), sa.ForeignKey("auth_users.id"), nullable=False),
    ...
    op.create_index(
        "ix_workflow_relation_reviews_ref", "workflow_relation_reviews", ["ai_relation_ref_id"]
    )
    op.create_table(
        "workflow_impact_analyses",
        sa.Column("id", sa.String(36), primary_key=True),
        ...
        sa.Column("ai_analysis_id", sa.String(255), nullable=False, unique=True),
        sa.Column("status", sa.String(30), nullable=False),
        sa.Column("effect_count", sa.Integer(), nullable=False),
        sa.Column("approved_effect_count", sa.Integer(), nullable=False),
        sa.Column("requested_by", sa.String(36), sa.ForeignKey("auth_users.id"), nullable=False),
        sa.Column("reviewed_by", sa.String(36)),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
