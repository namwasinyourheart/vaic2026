...
const LOGS = [
  ...
  { id: 'L-0003', time: '17/01/2024 09:30:01', actor: 'Nguyễn Văn An', role: 'Bank Employee', action: 'UPLOAD_DOCUMENT', target: 'doc:QĐ-SHB-2024/01', result: 'success', ip: '192.168.1.45' },
  ...
  { id: 'L-0005', time: '16/01/2024 14:20:15', actor: 'Trần Thị Bình', role: 'Bank Employee', action: 'APPROVE_METADATA', target: 'doc:QĐ-SHB-2023/18', result: 'success', ip: '192.168.1.52' },
  ...
  { id: 'L-0009', time: '15/01/2024 16:05:30', actor: 'Admin Hệ thống', role: 'Admin', action: 'UPDATE_PERMISSIONS', target: 'role:bank_employee', result: 'success', ip: '192.168.1.100' },
  { id: 'L-0010', time: '15/01/2024 11:23:18', actor: 'Lê Minh Cường', role: 'Bank Employee', action: 'REJECT_CLAUSE', target: 'clause:QC-CVTD-2023/Điều12', result: 'success', ip: '192.168.1.67' },
]
  ...
  return (
    <AppLayout role="admin" pageTitle="Nhật ký hệ thống">
      ...
      <div className="flex gap-3 mb-4 flex-wrap">
        ...
        {[
          { label: 'Tất cả vai trò', opts: ['Admin', 'Bank Employee', 'Customer'] },
                ...
                <tr key={log.id} className="border-b border-[#DDE1E9] hover:bg-[#F8FAFC] transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <span className={`text-xs px-1.5 py-0.5 rounded font-medium ${
                      ...
                      : log.role === 'Bank Employee' ? 'bg-amber-100 text-amber-700'
